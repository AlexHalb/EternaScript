...
## Taken from the instructions for EternaJS
...
* Most of the action takes place in the engines directory (for building the engines)
* To go back a directory in the terminal, use `cd ..`
* 